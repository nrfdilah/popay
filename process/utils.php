...
function bulanPengelolaToNum($b) {
...
function saltHash($str) {
    return hash("md5", "tlas".hash("sha256", "x3".hash("ripemd160", "popay{$str}isda")."3x")."salt");
}
...
function sendMail($mto, $msubject, $mbody)
{
    ...
    $body = $mbody;
    $headers = 'From: Popay' . "\r\n";
    $headers .= 'Reply-To: noreply@popay.com' . "\r\n";
    $headers .= 'Return-Path: noreplay@popay.com' . "\r\n";
