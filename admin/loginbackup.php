    ...
    <nav class="navbar fixed-top white navbar-expand-lg navbar-light" style="background-color: #4B6ED4;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                 <a class="nav-link pointer" href="../admin/daftarpengelola.php" style="color: #ffffff; font-size: 20px;">Daftar Pengelola/Admin</a>
                </li>
...
<br><br>
        <h2 class="font-weight-light" style=" background-color: #4B6ED4; color: #fff;">
                <i class="fas fa-user" aria-hidden="true"></i> Login Admin</h2>
            ...
            <div class="login">
                <form action="../aksi/login_admin.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" style="border-radius: 0px; border: 1px solid #070707;" name="userpass" class="form-control" id="userpass" placeholder="Kata Sandi">
                    </div>
